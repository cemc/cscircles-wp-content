...
Sweetcodes fix exactly these three problems. 

As a bonus, they also accept Pascal-style "" or '' quote-escapes.

A stopgap fix for another issue
===============================
...
go inside of each sweetcode and delete all newlines inside of them.
(Except newlines inside of a <pre> change to <br/>.)

(deleting newlines in just the body is better, but this seems tricky
since the body may contain args for inner nested shortcodes)

With this, one should use a [br] shortcode that turns into <br>.
