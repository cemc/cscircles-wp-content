...
function pbmailpage($options, $content) {
  ...
  foreach ($messages as $i=>$message) {
    ...
    $r .= "<div class='collapseBody'><span class='quoth'>Quote/<br/>Reply</span>".preBox($message['body'], -1,10000,"font-size:12px; line-height:14px; white-space: pre-wrap;").'</div>';
    $r .= '</div>';
  }
...
<textarea name="body" class="resizy" placeholder="Type here to send a reply about this problem" style="width:100%; white-space: pre-wrap; font-size: 11px; line-height:13px" rows=12></textarea>
</div>
'.$to.'
