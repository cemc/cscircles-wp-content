...
class GoogleCSE
{
	...
	public static function run()
	{
		...
		// setup user options
                ...
                //DP: let's use normal WP search URL, not this plugin's hijacked /search
		//self::$search_url = get_option('home') . '/search/';
                self::$search_url = home_url( '/' );

                //DP: remove this from a plugin option, hardcode it
		//self::$google_search_box = stripslashes(get_option('cse-search-box-code'));
                self::$google_search_box = '<form id="cse-search-box" action="this-gets-replaced">
     <input type="text" name="s" size="31" />
   <img src="http://www.google.com/cse/images/google_custom_search_smwide.gif">
</form>';
                
                //DP: for reference, this is what's in my cse-search-results-code:
                /*
...
<script type="text/javascript"> 
  ...
  google.setOnLoadCallback(function() {
    ...
    var customSearchControl = new google.search.CustomSearchControl(
      '007230231723983473694:r0-95non7ri', customSearchOptions);
