...
<?php
	...
	<tbody>
		...
		<tr>
			...
			<td>
				<textarea name='wp_latex[css]' id='wp-latex-css' rows="8" cols="50"><?php echo esc_html( $values['css'] ); ?></textarea>
			</td>
		</tr>
		...
		<tr class="wp-latex-method wp-latex-method-dvipng wp-latex-method-dvips<?php if ( in_array( 'wrapper', $errors ) ) echo ' form-invalid	'; ?>">
			...
			<td>
				<textarea name='wp_latex[wrapper]' rows='8' cols="50" id='wp-latex-wrapper'><?php echo esc_html( $values['wrapper'] ); ?></textarea>
			</td>
		</tr>
